...
// Types not listed here are treated as a patch release by whatBump(). Keep tooling-only
// types (ci, build) hidden so they don't cut a release (and, with auto-deploy, a prod rollout).
const COMMIT_TYPES = [
